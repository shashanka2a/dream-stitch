    ...
    <section id="expertise" className="bg-white py-12 sm:py-16 md:py-20 lg:py-24 xl:py-[120px] px-4 sm:px-6 md:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 sm:mb-8 md:mb-10 lg:mb-12 reveal text-left">
          <span className="uppercase tracking-[0.3em] text-[11px] sm:text-[12px] opacity-40 block mb-3 sm:mb-4 md:mb-6">The Process</span>
          <h2 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 sm:gap-x-8 md:gap-x-12 gap-y-12 sm:gap-y-14 md:gap-y-16 lg:gap-y-20 xl:gap-y-24">
          {processes.map((process) => (
            ...
            >
              <div className="w-[34px] h-[34px] md:w-[39px] md:h-[39px] mb-12 opacity-15 transition-opacity group-hover:opacity-30 text-gray-400">
